...
# project_2/ -- the directory that holds .env, warehouse/ and output/
...
# The case-study repo sits next to project_2/ and is where the CSVs ship.
# Defaulting to it means a fresh clone runs without a .env; RETAILPULSE_LOCAL_RAW
# overrides it if you move the data.
...
class RunConfig:
    ...
    def raw_path(self, dataset: str) -> str:
        ...
        The only place a path differs between modes: a local folder versus a
